...
if (isset($_ENV['AH_SITE_ENVIRONMENT'])) {
  switch ($_ENV['AH_SITE_ENVIRONMENT']) {
    ...
    case 'prod':
      ...
      $conf['securepages_basepath'] = 'https://dh.library.virginia.edu';
      $conf['securepages_basepath_ssl'] = 'https://dh.library.virginia.edu';
      $conf['simplesamlphp_auth_installdir'] = "/var/www/simplesamlphp";
      $conf['simplesamlphp_auth_authsource'] = "dh.library.virginia.edu-shib-prod";
}
 ...
 */
$db_url = ''; /* 'mysql://dh_drupal_1:eiquaibai4Ohva@rds-standard-staging.internal.lib.virginia.edu/dh_drupal_1'; */
$db_prefix = '';
...
$base_url = $PROTO.'://'.$_SERVER['SERVER_NAME'].$PORTPS;
/**
 * PHP settings:
 *
...
$databases = array (
  ...
  array (
    ...
    array (
      'driver' => 'mysql',
      'database' => 'dh_drupal_1',
      'username' => 'dh_drupal_1',
      'password' => 'eiquaibai4Ohva',
...
$databases = array (
  ...
  array (
    'default' => 
    array (
      'database' => 'dh_drupal_0',
      'username' => 'dh_drupal_0',
      'password' => 'NuaNaeTaS4ique',
